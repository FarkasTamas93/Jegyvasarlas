...
public class Event {
    ...
    public Event(String imagePath, String title, String description, String town, String address, String time, String eventType, String eventGenre, String ticketType0, String ticketType1, String ticketType2, String ticketType3, String ticketType4, int ticketPrice0, int ticketPrice1, int ticketPrice2, int ticketPrice3, int ticketPrice4) {
